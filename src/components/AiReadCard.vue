...
function startGpt() {
    if (!props.text){
        ...
        if (!question.value) {
            ...
            formdata.append("gpt_message", "你好，如果我没有提关于文章的问题请直接回复我的提问不涉及文章，如果我的问题和文章内容有关则需要参考文章回答，请自行判断，问题如下:" + question.value + "。文章内容如下（注意文章是用markdown格式书写的）：" + props.text);
...
/* function startGptStream() {
    if (!props.text) {
        ...
        if (!question.value) {
            ...
            gpt_response.value="";
            let gpt_message = "你好，如果我没有提关于文章的问题请直接回复我的提问不涉及文章，如果我的问题和文章内容有关则需要参考文章回答，请自行判断，问题如下:" + question.value + "。文章内容如下（注意文章是用markdown格式书写的）：" + props.text;
